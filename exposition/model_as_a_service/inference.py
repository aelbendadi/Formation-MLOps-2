...
def predict_endpoint():
    features = prepare_features(data=received_data_df, training_mode=False)
    prediction = predict(features, MODEL_PATH)
    return jsonify(prediction['predictions'].to_json())
